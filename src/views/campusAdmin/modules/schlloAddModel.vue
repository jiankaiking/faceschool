  ...
  >
    <el-form  :model="form" ref="form" :rules="rules" label-width="100px">
      ...
      <el-form-item label="学制" prop="schoolSystem">
        <global-select type="educationalType" :select-v.sync="form.schoolSystem" />
      </el-form-item>
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" @click="ok('form')"
        >确 定</el-button
      >
    </div>
  </el-dialog>
  ...
  data() {
    return {
      ...
      rules:{
        ...
        schoolIntroduction: [{ required: true, message: "请输入学校介绍", trigger: "blur" }],
      },
      form: {
        schoolName: "",
        regionLongCode: "",

  ...
  >
    ...
    <div style="margin-top: 30px;">
      <el-table :data="depositInfo.depositIog" border style="width: 100%">
        ...
        <el-table-column prop="scene" label="类型"></el-table-column>
...
.info-title::before {
  ...
  .info-messages{
    padding: 20px 50px; box-sizing: border-box; display: flex; flex-wrap: wrap; width: 100;
  }
  .info-messages span{
    width: 50%; margin-bottom: 30px; font-size: 16px;
  }
</style>
